...
$supplier_details = $this->suppliers_model->get_supplier($supplier_id);

if($supplier_details->num_rows() > 0)
{
	foreach ($supplier_details->result() as $key_supplier) {
		# code...
...
<html lang="en">
    <head>
        <title><?php echo $contacts['company_name'];?> | REQUEST FOR QUOTATION</title>
        <!-- For mobile content -->
    ...
    <body class="receipt_spacing">
      ...
      <div class="row receipt_bottom_border" >
    	...
    	<div class="row receipt_bottom_border" style="margin-bottom: 10px;">
        	...
        	<div class="col-md-5">
                ...
                <div class="row">
                	<div class="col-md-12">
                    	<strong>Date :</strong>
                    	<?php echo date('jS F Y',strtotime(date("Y-m-d"))); ?>
                    </div>
                </div>
            </div>
    	 ...
    	 <div class="row receipt_bottom_border" >
        	<div class="col-md-12">
        		<strong>PLEASE QUOTE THE FOLLOWING GOODS</strong>
        	</div>
        </div>
    	...
    	<div class="row">
         ...
         <div class="row receipt_bottom_border" >
        	<div class="col-md-12">
        		<strong>* QUOTE ABOVE ORDER NO ON ALL INVOICES AND DELIVERY NOTES</strong>
        	</div>
        </div>
    	<div class="row" style="font-style:italic; font-size:11px; margin-top:10px">
        	<div class="col-md-8 pull-left">
	            <div class="col-md-6 pull-left">
	            	<strong>Prepared by: </strong> <?php echo $this->session->userdata('first_name')?>
	            </div>
	            <div class="col-md-6 pull-left">
	              Signature by: .....................................
	            </div>
        ...
        $authorising_officer =  $this->orders_model->get_rfq_authorising_personnel($order_id);
        ?>
