<section class="panel">
        ...
        <header class="panel-heading">
          ...
          <div class="widget-icons pull-right">
          	<a href="<?php echo base_url().'pharmacy-setup/inventory';?>" class="btn btn-sm btn-info">Back to inventory</a>
          </div>
		...
		?>
            ...
            <?php echo form_open_multipart('pharmacy/validate-import', array("class" => "form-horizontal", "role" => "form"));?>
            
            <div class="row">
                <div class="col-md-12">
                    <ul>
                        <li>Download the import template <a href="<?php echo site_url().'pharmacy/import-template';?>">here.</a></li>
