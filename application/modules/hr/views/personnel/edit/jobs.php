    ...
    <div class="col-md-12">
      ...
      <div class="widget boxed">
        ...
        <div class="widget-head">
          <h4 class="pull-left"><i class="icon-reorder"></i>Personnel job history</h4>
                	...
                	<?php
						...
						{	
							foreach($departments->result() as $res)
							{
								...
								{
									echo '<option value="'.$department_id.'" selected>'.$departments_name.'</option>';
								}
								
								else
								{
									echo '<option value="'.$department_id.'">'.$departments_name.'</option>';
								}
							}
						}
					?>
