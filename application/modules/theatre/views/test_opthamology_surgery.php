...
$rs = $this->theatre_model->get_surgery_inpatient($visit_id,29);
$num_rows = count($rs);
...
foreach ($rs as $key6):
	...
	echo "
		<tr>
			...
			<td>
				<a class='btn btn-danger btn-sm' href='#' onclick='delete_inpatient_surgery_cost(".$visit_charge_id.", ".$visit_id.",29);'><i class='fa fa-trash'></i></a>
			</td>
		</tr>
	";
