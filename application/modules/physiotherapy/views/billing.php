<div class="row">
  ...
  <script type="text/javascript">
	  ...
	  window.open(config_url+"/physiotherapy/physiotherapy_services/"+visit_id,"Popup","height=1200, width=800, , scrollbars=yes, "+ "directories=yes,location=yes,menubar=yes," + "resizable=no status=no,history=no top = 50 left = 100");
	}
	...
	function display_billing(visit_id){
	    ...
	    var config_url = $('#config_url').val();
	    var url = config_url+"/physiotherapy/view_billing/"+visit_id;
	...
	function billing_grand_total(procedure_id, units, amount){
	    ...
	    var url = config_url+"/physiotherapy/billing_total/"+procedure_id+"/"+units+"/"+amount;
	...
	function delete_billing(id, visit_id){
	    ...
	    if (window.XMLHttpRequest) {
	     ...
	     var config_url = $('#config_url').val();
	    var url = config_url+"/physiotherapy/delete_billing/"+id;
