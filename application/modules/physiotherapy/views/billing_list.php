                        ...
                        <div class="padd">
                            <div class="row">
                                <div class="col-md-12">
									...
									echo form_open('physiotherapy/search_physiotherapy_billing/'.$visit_id, array('class'=>'form-inline'));
									?>
                                    <div class="form-group">
											...
											{
											?>
                                            <a href="<?php echo site_url().'/physiotherapy/close_physiotherapy_billing_search/'.$visit_id;?>" class="btn btn-warning pull-right">Close Search</a>
                                            <?php }?>
...
<script type="text/javascript">
  ...
  function billing_services(id, v_id, suck){
    ...
    var url = "<?php echo site_url();?>/physiotherapy/billing_service/"+id+"/"+v_id+"/"+suck;
   window.alert(url);
    if(XMLHttpRequestObject) {
        ...
        XMLHttpRequestObject.onreadystatechange = function(){
            ...
            if (XMLHttpRequestObject.readyState == 4 && XMLHttpRequestObject.status == 200) {
				...
				$.get( "<?php echo site_url();?>/physiotherapy/view_billing/"+v_id, function( data ) {
