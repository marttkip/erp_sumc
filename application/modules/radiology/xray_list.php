    ...
    <div class="col-md-12">
        <section class="panel panel-featured panel-featured-info">
            <header class="panel-heading">
            	<h2 class="panel-title">X Ray lists</h2>
            </header> 
...
<div class="row">
    <div class="col-md-12">
        <section class="panel panel-featured panel-featured-info">
            <header class="panel-heading">
            	<h2 class="panel-title">Selected X Rays</h2>
            </header> 
            <div class="panel-body">
...
var config_url = '<?php echo site_url();?>';
    ...
    function get_xray_table(visit_id){
        ...
        var url = config_url+"xray/test_xray/"+visit_id;
        //window.alert(url)   ;
   ...
   function xray(id, visit_id){
    ...
    var url = "<?php echo site_url();?>xray/test_xray/"+visit_id+"/"+id;
...
function get_test_results(page, visit_id){
  ...
  if((page == 1) || (page == 65) || (page == 85)){
    ...
    url = config_url+"xray/test/"+visit_id;
  }
  
  else if ((page == 75) || (page == 100)){
    url = config_url+"xray/test1/"+visit_id;
  }
  if(XMLHttpRequestObject) {
    if((page == 75) || (page == 85)){
...
function delete_cost(visit_charge_id, visit_id){
	...
	var url = config_url+"xray/delete_cost/"+visit_charge_id+"/"+visit_id;
	window.alert(url);
