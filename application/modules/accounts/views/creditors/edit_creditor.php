...
else
{
	...
	$creditor_location = $row->creditor_location;
	$creditor_building = $row->creditor_building;
	$creditor_floor = $row->creditor_floor;
	$creditor_address = $row->creditor_address;
	$creditor_post_code = $row->creditor_post_code;
	$creditor_city = $row->creditor_city;
	$creditor_contact_person_name = $row->creditor_contact_person_name;
	$creditor_contact_person_onames = $row->creditor_contact_person_onames;
	$creditor_contact_person_phone1 = $row->creditor_contact_person_phone1;
	$creditor_contact_person_phone2 = $row->creditor_contact_person_phone2;
	$creditor_contact_person_email = $row->creditor_contact_person_email;
	$creditor_description = $row->creditor_description;
}
?>
          <section class="panel">
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-7">
            	<input type="text" class="form-control" name="creditor_contact_person_phone1" placeholder="Contact Phone 1" value="<?php echo $creditor_contact_person_phone1;?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-7">
            	<input type="text" class="form-control" name="creditor_contact_person_phone2" placeholder="Contact Phone 2" value="<?php echo $creditor_contact_person_phone2;?>">
            </div>
        </div>
...
<div class="row" style="margin-top:10px;">
	<div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
            	<textarea class="form-control" name="creditor_description" rows="5"><?php echo $creditor_description;?></textarea>
            </div>
        </div>
    </div>
</div>
